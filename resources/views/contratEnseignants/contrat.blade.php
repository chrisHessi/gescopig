        ...
        <section class="content container-fluid .page-break" >
            <div class="container-fluid">
                ...
                <div id="contenu">
                    ...
                    <p>Et</p>
                    <p>
                        Monsieur/Madame {!! '<strong>'.$contrat->enseignant->name.'</strong> ; né(e) le <strong>'. (($contrat->enseignant->date_naissance) ? $contrat->enseignant->date_naissance->format('d/m/Y') : ''). ' à '. $contrat->enseignant->lieu_naissance .'</strong>; deumerant à <strong>'. $contrat->enseignant->domicile .';</strong> nationalité : <strong>Camerounaise</strong>, ci après désigné(e) <strong>l\'enseignant</strong> '!!}
                    </p>
                    <p>
