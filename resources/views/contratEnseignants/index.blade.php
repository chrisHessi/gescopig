                            ...
                            <td>
                                ...
                                <div class='btn-group'>
                                    ...
                                    {!! Form::open(['route' => ['contratEnseignants.destroy', $contrat->id], 'method' => 'delete']) !!}
                                        ...
                                        @endcan
                                    {!! Form::close() !!}
                                <a href="{!! route('contratEnseignants.contrat', [$contrat->id]) !!}" class='btn btn-warning btn-xs' title="voir les versements de l'enseignant"><i class="glyphicon glyphicon-print"></i></a>
                                </div>
